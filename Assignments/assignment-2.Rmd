...
Not sure why I couldn't get the lines to appear on the graph.

Im going to look at Marc's code now
...
new_weights <- seq(from = 25, to = 70)
# 2. Simulate predicted heights using the likelihood height_i ∼ Normal(mu_i, sigma).
