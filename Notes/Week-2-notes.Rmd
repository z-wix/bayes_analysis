...
1. __Design__ the model, _data story_
...
- Some true proporation of water, _p_
- toss the globe, probably _p_ of observting W, 1-p of L
- Each toss therefore indepent of other tosses

Translate data story into probability statments
...
So let's code this math. Not sure what this is telling me though, is this the likelihood of W occuring or of L? or something different?
...
Posterior = ( (pro observed variables) x (prior) )/ Normalizing constant
...
# Define the posterior multiplicaiton give it the shape
...
samples <- sample(prob_p, prob = posterior, size = 1e4, replace = TRUE)
